...
06/03/98 - Sasha
   - Added GetPriceWithCapital, GetIntPriceWithCapital, GetHyperEPriceWithCapital functions
06/02/98 - Sasha
...
*/
  ...
  public double GetPriceWithCapital() {
   ...
   public double GetIntPriceWithCapital() {
      double add_to_price = this.capital * MiscFunc.CAPITAL_FACTOR;
      if ( add_to_price > 1.0 )  add_to_price = 1.0;
      if ( add_to_price < -1.0 ) add_to_price = -1.0;
     return (3.0 - 2.0 * (double) this.numLeft / TARGET_BANNERS + 1.0
  ...
  public double GetHyperEPriceWithCapital() {
      double add_to_price = this.capital * MiscFunc.CAPITAL_FACTOR;
      if ( add_to_price > 1.0 )  add_to_price = 1.0;
      if ( add_to_price < -1.0 ) add_to_price = -1.0;
      return (1.0 +  (TARGET_BANNERS - (double) this.numLeft)
