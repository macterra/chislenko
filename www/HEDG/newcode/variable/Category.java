...
public class Category extends HyperE{
  ...
  double[] catClicksTotal       = new double[MiscFunc.NUM_CATEGORIES];
  double[] catDisplaysTotal     = new double[MiscFunc.NUM_CATEGORIES];
  ...
  public void RestartCatCount() {
    ...
    for (i=0; i < MiscFunc.NUM_CATEGORIES; i++) {
      catClicks[i]        = 0.0;
      catDisplays[i]      = 0.0;
      catClicksTotal[i]   = 0.0;
      catDisplaysTotal[i] = 0.0;
    }
  }
